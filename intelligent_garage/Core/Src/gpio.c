...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LED_GREEN_Pin LED_RED_Pin SD_CS_Pin TRIG_IN_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin|LED_RED_Pin|SD_CS_Pin|TRIG_IN_Pin;
  ...
  /*Configure GPIO pin : MAN_BTN_Pin */
  GPIO_InitStruct.Pin = MAN_BTN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(MAN_BTN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ECHO_OUT_Pin */
  GPIO_InitStruct.Pin = ECHO_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ECHO_OUT_GPIO_Port, &GPIO_InitStruct);
